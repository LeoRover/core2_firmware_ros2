...
constexpr const char* wheel_pwm_duty_limit_param_name =
    "wheels/pwm_duty_limit";
constexpr const char* mecanum_wheels_param_name = "mecanum_wheels";
constexpr const char* dd_wheel_radius_param_name =
...
constexpr const char* dd_input_timeout_param_name =
    "diff_drive/input_timeout";
constexpr const char* battery_min_voltage_param_name =
    "battery_min_voltage";
